...
function ResourcePattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
          className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#fffde7] to-[#fff9c4] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#2e2a20] dark:to-[#343428]"
          style={style}
      />
      <motion.div
