...
With Strela, you can create a single Minecraft server, including proxies like Velocity or BungeeCord, or normal servers like Spigot or Paper. You can also create multiple servers and proxies and manage them all in one place. {{ className: 'lead' }}
